# Generated by Django 6.0 on 2025-12-03 18:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('seminar', 'Seminar'), ('lomba', 'Lomba'), ('workshop', 'Workshop')], default='seminar', max_length=20)),
                ('date_time', models.DateTimeField()),
                ('location', models.CharField(max_length=200)),
                ('price', models.DecimalField(decimal_places=0, default=0, max_digits=10)),
                ('status', models.CharField(choices=[('pending', 'Menunggu Validasi Admin'), ('active', 'Aktif / Tayang'), ('rejected', 'Ditolak')], default='pending', max_length=20)),
